...
/**
 * Resolve Gclm Code-specific path patterns for sandbox-runtime.
 *
 * Gclm Code uses special path prefixes in permission rules:
...
/**
 * Convert Gclm Code settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Gclm Code started)
