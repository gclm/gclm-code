...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Gclm Code was first started on this machine
  ...
  // Gclm Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Gclm Code OAuth token
  ...
  // Gclm Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
