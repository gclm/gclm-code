...
const externalTips: Tip[] = [
  ...
  },
  {
    id: 'prompt-queue',
    content: async () =>
      'Hit Enter to queue up additional messages while Gclm Code is working.',
    cooldownSessions: 5,
    async isRelevant() {
      const config = getGlobalConfig()
  ...
  },
  {
    id: 'paste-images-mac',
    content: async () =>
      'Paste images into Gclm Code using control+v (not cmd+v!)',
    cooldownSessions: 10,
  ...
  },
  {
    id: 'continue',
    content: async () =>
      'Run gc --continue or gc --resume to resume a conversation',
    cooldownSessions: 10,
    isRelevant: async () => true,
  },
  {
  ...
  },
  {
    id: 'desktop-app',
    content: async () =>
      'Run Gclm Code locally or remotely using the Claude desktop app: clau.de/desktop',
    cooldownSessions: 15,
  ...
  },
  {
    ...
    content: async ctx => {
      ...
      return `Continue your session in Gclm Code Desktop with ${blue('/desktop')}`
    },
    cooldownSessions: 15,
    isRelevant: async () => {
  ...
  },
  {
    id: 'mobile-app',
    content: async () =>
      '/mobile to use Gclm Code from the Claude app on your phone',
    cooldownSessions: 15,
    isRelevant: async () => true,
  },
  {
  ...
  },
  {
    ...
    content: async ctx => {
      ...
      return reward
        ? `Share Gclm Code and earn ${claude(formatCreditAmount(reward))} of extra usage · ${claude('/passes')}`
