...
/**
 * Gclm Code parses history for pasted content references to match back to
...
export function addToHistory(command: HistoryEntry | string): void {
  // Skip history when running in a tmux session spawned by Gclm Code's Tungsten tool.
