...
export function registerScheduleRemoteAgentsSkill(): void {
  registerBundledSkill({
    ...
    whenToUse:
      'When the user wants to schedule a recurring remote agent, set up automated tasks, create a cron job for Gclm Code, or manage their scheduled agents/triggers.',
    userInvocable: true,
    isEnabled: () =>
