...
Hooks run commands at specific points in Gclm Code's lifecycle.
...
Modify Gclm Code configuration by updating settings.json files.
...
6. **Use --debug** - Run \`gc --debug\` to see hook execution logs
`
