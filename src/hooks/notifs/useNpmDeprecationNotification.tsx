...
const NPM_DEPRECATION_MESSAGE = 'Gclm Code has switched from npm to native installer. Run `gc install` or see https://docs.anthropic.com/en/docs/claude-code/getting-started for more options.';
