export const PR_TITLE = 'Add Gclm Code GitHub Workflow'

export const GITHUB_ACTION_SETUP_DOCS_URL =
  'https://github.com/anthropics/claude-code-action/blob/main/docs/setup.md'

export const WORKFLOW_CONTENT = `name: Gclm Code
...
export const PR_BODY = `## 🤖 Installing Gclm Code GitHub App

This PR adds a GitHub Actions workflow that enables Gclm Code integration in our repository.

### What is Gclm Code?

[Gclm Code](https://claude.com/claude-code) is an AI coding agent that can help with:
...
There's more information in the [Gclm Code action repo](https://github.com/anthropics/claude-code-action).

After merging this PR, let's try mentioning @claude in a comment on any PR to get started!`

export const CODE_REVIEW_PLUGIN_WORKFLOW_CONTENT = `name: Gclm Code Review
