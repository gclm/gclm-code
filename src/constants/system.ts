...
const DEFAULT_PREFIX = `You are Gclm Code, Anthropic's official CLI.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Gclm Code, Anthropic's official CLI, running within the Claude Agent SDK.`
