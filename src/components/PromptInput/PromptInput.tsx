  ...
  useEffect(() => {
    if (feature('ULTRAPLAN') && ultraplanTriggers.length) {
      addNotification({
        ...
        text: 'This prompt will launch an ultraplan session in Gclm Code on the web',
        priority: 'immediate',
        timeoutMs: 5000
      });
    } else {
