...
export function IdeOnboardingDialog(t0) {
  ...
  if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Text color="startupAccent">✻ </Text>;
    $[7] = t5;
  } else {
    t5 = $[7];
  }
  let t6;
  if ($[8] !== ideName) {
    t6 = <>{t5}<Text>Welcome to Gclm Code for {ideName}</Text></>;
    $[8] = ideName;
    $[9] = t6;
  } else {
    t6 = $[9];
  ...
  if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
    t11 = <Text>• Review Gclm Code's changes{" "}{t10}{" "}<Text color="diffRemovedWord">-22</Text> in the comfort of your IDE</Text>;
    $[13] = t11;
  } else {
    t11 = $[13];
  }
