...
export const DESCRIPTION = 'Get or set Gclm Code configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Gclm Code configuration settings.

  View or change Gclm Code settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
